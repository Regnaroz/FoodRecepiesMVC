...
namespace AspnetCoreMvcFull.Controllers
{
    public class TestModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Text,TextAr")] TestModel testModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text,TextAr")] TestModel testModel)
        {
            if (id != testModel.Id)
            {
                return NotFound();
